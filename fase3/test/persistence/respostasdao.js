...
class RespostasDAO extends Database {
    ...
    Insert(respostas, callback) {
        const sql = `
        INSERT INTO resposta (id, id_pergunta, resposta_opcao, resposta_correta) VALUES (null, '${respostas.id_pergunta}', '${respostas.resposta_opcao}', '${respostas.resposta_correta})' `;
        this.query(sql, callback);
    }

    getAll(callback) {
        const sql = 'SELECT id, id_pergunta, resposta_opcao, resposta_correta FROM respostas '
