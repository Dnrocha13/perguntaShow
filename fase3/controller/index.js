...
const PerguntasRespostasService = require('../service/perguntasrespostasservice');
...
const perguntasRespostasService = new PerguntasRespostasService(config);
...
app.get("/api/perguntas/respostas", (req, res) => { 
  ...
  perguntasService.buscarTodasAsPerguntas((err, pergunta) => {
    ...
    let result = perguntasRespostasService.getAll(pergunta, resposta)
